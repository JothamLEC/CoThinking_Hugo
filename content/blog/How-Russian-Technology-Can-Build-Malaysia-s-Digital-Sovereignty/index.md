...
author = ["Jotham Lim"]
description = "Malaysian companies face rising cybersecurity threats following rapid cloud adoption. This report examines how Russian firm eXpress.ms aims to address these vulnerabilities with their digital sovereignty-focused technology."
date = 2024-09-25
...
The pandemic saw Malaysian companies scrambling to move their communication towards the cloud. Five years later, workers are now back in offices, but the new systems and policies remain in place — perhaps out of convenience, improved productivity or sunk cost.
...
## Powering communication for Russia's essential services {#powering-communication-for-russia-s-essential-services}
...
## Building walled gardens for corporations {#building-walled-gardens-for-corporations}

{{< figure src="Screenshot_2.jpeg" alt="Mobile preview of eXpress.ms messenger" >}}

{{< figure src="Screenshot_1.jpeg" alt="Preview of eXpress.ms solutions" >}}
...
The decision to avoid open-source dependencies is not optional — but crucial to the eXpress.ms' success.

To operate in the Russian IT market, authorities require providers to obtain the FSTEC (Federal Service for Technical and Export Control) certification.

To qualify for the certification, the solution's source code is reviewed by independent testing centres for potential back doors that allow data to be transferred or altered without permission. That minimises risks of espionage — an aspect Russia is known to be cautious of.
...
## Solving a gap in the market. {#solving-a-gap-in-the-market-dot}

Before eXpress.ms, Andrey had worked in one of the largest system integrators in the country.
...
"Finally, it is about demand for the product. Some countries, they may have a large population, they may be organised, but perhaps they don't prioritise cybersecurity. Malaysia is open to adopting Russian technologies, is organised from top to bottom, and checks all these boxes. We consider it a hub for future activities."
